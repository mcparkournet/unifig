[![Build Status](https://travis-ci.org/mcparkournet/unifig.svg?branch=master)](https://travis-ci.org/mcparkournet/unifig)
...
dependencies {
    implementation("net.mcparkour:unifig-gson:2.0.2")
}
```
